...
KISSY.add('app/views/report/zone/zone_table', function (S, View, VOM, Node, MM, Util) {
    ...
    return View.extend({
        ...
        render: function () {
            ...
            var fetchName = me._getFetchName();
        ...
        _getFetchName: function () {
            var me = this;
            var params = me.location.params;
            var type = me.getManaged('data').type;
            switch (type) {
            case 'self':
                return 'report_zone_self_table';
                break;
            case 'widget':
                return 'report_zone_widget_table';
                break;
            case 'channel':
                return 'report_zone_channel_table';
                break;
            case 'weibo':
                return 'report_zone_weibo_table';
                break;
            case 'software':
                return 'report_zone_software_table';
                break;
            default:
                return 'report_zone_self_table';
            }
