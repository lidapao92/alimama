Magix.tmpl("app/views/report/detail/rights","<div class=\"wrap-hd clearfix\"> <div class=title-bar> <h2 class=title> 淘宝客维权退款订单明细 <i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tl','bl']},mouseDelay:0.2,width:300,content:'用户线上发起维权退款，并成功退款的订单明细。这部分订单产生的收入将不予结算。'}\">&#360;</i> </h2> </div> </div> <div class=table-container> <div class=\"toolbar clearfix\"> <div class=table-settings bx-tmpl=\"download\" bx-datakey=\"searchType,startTime,endTime\"> <a href=\"/report/getNewTbkRefundPaymentDetails.json?refundType=1&searchType={{searchType}}&DownloadID=DOWNLOAD_EXPORT_CPSPAYMENT_REFUND_OVERVIEW&startTime={{startTime}}&endTime={{endTime}}\" class=\"btn btn-size25\" title=\"下载报表\"><i class=iconfont>&#392;</i></a> </div> <div bx-name=\"dropdown\" class=dropdown hidefocus=true id=J_time_dropdown style=\"width:120px;\" bx-tmpl=\"timeList\" bx-datakey=\"timeList\"> {{#timeList}} {{#selected}} <span class=dropdown-hd> <span class=dropdown-text value=\"{{timeId}}\">{{timeName}}</span> <i class=\"iconfont icon-arrow-down\">&#459</i> </span> {{/selected}} {{/timeList}} <ul class=dropdown-list> {{#timeList}} <li class=\"dropdown-item {{#selected}}dropdown-itemselected{{/selected}}\"><span value=\"{{timeId}}\">{{timeName}}</span><i class=\"iconfont icon-ok\">&#126</i></li> {{/timeList}} </ul> </div> <a href=\"#\" class=\"btn btn-size25\" id=sitemapTimeRange bx-tmpl=\"dateRange\" bx-datakey=\"startTime,endTime\"> {{startTime}} 至 {{endTime}} </a> </div> <table class=table bx-name=\"tables\" bx-tmpl=\"list\" bx-datakey=\"list\"> <thead> <tr {{^list}}class=no-data{{/list}}> <th class=left width=120>淘宝订单编号</th> <th class=left width=120>淘宝子订单编号</th> <th class=left width=90>维权退款金额<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tl','bl']},mouseDelay:0.2,width:170,content:'买家申请维权退款的金额。'}\">&#360;</i></th> <th class=left width=80>应返还金额<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tl','bl']},mouseDelay:0.2,width:220,content:'应该返还给卖家的佣金+补贴之和。'}\">&#360;</i></th> <th class=left>维权状态<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tl','bl']},mouseDelay:0.2,width:200,content:'维权各状态含义&lt;a href=&quot;http://help.alimama.com/#!/taoke/faq/detail?id=13114133&quot; target=&quot;_blank&quot; class=&quot;color-blue&quot;&gt;点此查看&lt;/a&gt;'}\">&#360;</i></th> <th class=left width=90>订单结算时间<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tl','bl']},mouseDelay:0.2,width:200,content:'订单扣除佣金时间，一般等于买家确认收货时间。'}\">&#360;</i></th> <th class=left width=90>维权创建时间<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tr','br']},mouseDelay:0.2,width:150,content:'买家发起维权的时间。'}\">&#360;</i></th> <th class=left width=90>维权完成时间<i class=\"iconfont cursor-pointer fontsize-13 ml2\" bx-name=\"tooltip\" bx-config=\"{closable:false,align:{node:false,points:['tr','br']},mouseDelay:0.2,width:180,content:'订单维权成功&失败的时间。'}\">&#360;</i></th> </tr> </thead> <tbody> {{#list}} <tr> <td class=left>{{tbTradeParentId}}</td> <td class=left>{{tbTradeId}}</td> <td class=left> {{list_refundFee}} </td> <td class=left> {{list_showReturnFee}} </td> <td class=left> {{#showRefundStatus}} {{showRefundStatus}} {{/showRefundStatus}} {{^showRefundStatus}} -- {{/showRefundStatus}} </td> <td class=left> {{#earningTime}} {{earningTime}} {{/earningTime}} {{^earningTime}} -- {{/earningTime}} </td> <td class=left> {{#refundCreateTime}} {{refundCreateTime}} {{/refundCreateTime}} {{^refundCreateTime}} -- {{/refundCreateTime}} </td> <td class=left> {{#refundFinishTime}} {{refundFinishTime}} {{/refundFinishTime}} {{^refundFinishTime}} -- {{/refundFinishTime}} </td> </tr> {{/list}} {{^list}} <tr class=none> <td colspan=8>暂无数据</td> </tr> {{/list}} </tbody> </table> <div class=tfoot> <div id=J_table_pagination bx-name=\"pagination\" class=pagination bx-config=\"{count:{{pageCount}},index:{{pageNo}},size:{{pageSize}},sizes:[20,40],simplify:true,statistics:true,sizeChange:true,jump:true,goTo:false}\"> </div> </div>");
KISSY.add('app/views/report/detail/rights', function (S, View, VOM, Node, MM, Util) {
    var $ = Node.all;
    return View.extend({
        init: function (e) {
            var me = this;
